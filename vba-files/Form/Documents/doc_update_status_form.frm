VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} doc_update_status_form 
   Caption         =   "Corrigir a situação do documento (Retorno - Fluxo de Aprovação)"
   ClientHeight    =   10890
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   16290
   OleObjectBlob   =   "doc_update_status_form.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "doc_update_status_form"
